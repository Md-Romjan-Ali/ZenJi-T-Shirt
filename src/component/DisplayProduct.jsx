                        ...
                        >
                            ...
                            <div className="relative aspect-[3/4] w-full overflow-hidden bg-neutral-200 dark:bg-neutral-900">
                                ...
                                <button
                                    ...
                                    className="absolute top-3 right-3 p-2 rounded-full bg-black/40 hover:bg-black/80 backdrop-blur-md text-white transition-colors"
                                >
                                    <FiHeart className="w-4 h-4" />
                                </button>

                                {/* Bottom Quick Add Overlay Button */}
                                <div className="absolute inset-x-3 bottom-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <button className="w-full py-2.5 bg-white text-black font-semibold text-xs tracking-wider uppercase rounded-lg shadow-lg flex items-center justify-center gap-2 hover:bg-neutral-200 transition-colors">
